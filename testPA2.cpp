...
int main() 
{
    ...
    Test0.push_back(Card('D', 12));
    Test0.push_back(Card('H', 13));
    Test0.push_back(Card('S',  7));
    Test0.push_back(Card('H', 12));
    Test0.push_back(Card('C',  7));
    Test0.push_back(Card('D',  7));
    Test0.push_back(Card('H', 10));

    Test1.push_back(Card('S', 10));
    Test1.push_back(Card('D',  6));
    Test1.push_back(Card('H', 12));
    Test1.push_back(Card('H', 11));
    Test1.push_back(Card('D', 13));
    Test1.push_back(Card('C',  6));
    Test1.push_back(Card('H', 14));

    Test2.push_back(Card('S', 12));
    Test2.push_back(Card('H',  7));
    Test2.push_back(Card('H', 10));
    Test2.push_back(Card('H',  8));
    Test2.push_back(Card('H', 12));
    Test2.push_back(Card('H',  9));
    Test2.push_back(Card('H',  6));

    Test3.push_back(Card('D', 14));
    Test3.push_back(Card('S',  6));
    Test3.push_back(Card('C',  6));
    Test3.push_back(Card('C',  3));
    Test3.push_back(Card('C', 10));
    Test3.push_back(Card('C',  2));
    Test3.push_back(Card('C',  7));
    
    Test4.push_back(Card('C',  3));
    Test4.push_back(Card('H', 11));
    Test4.push_back(Card('D',  9));
    Test4.push_back(Card('C', 11));
    Test4.push_back(Card('D', 11));
    Test4.push_back(Card('S', 10));
    Test4.push_back(Card('S', 11));
